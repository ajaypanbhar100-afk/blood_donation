...
<body>
  <div class="header">
    ...
    <a href="why_donate_blood.php"  <?php if($active=='why') echo "class='act'"; ?>>Why Donate Blood</a>
      ...
      <a href="donationcamp.php" <?php if($active=='camp') echo "class='act'"; ?>>Donation Camp</a>
      <a href="contact_us.php" <?php if($active=='contact') echo "class='act'"; ?>>Contact Us</a>
      <a href="gallery.php" <?php if($active=='contact') echo "class='act'"; ?>>Gallery</a>
    </div>
  </div>
