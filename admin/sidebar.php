...
<div class="sidebar" ><b>
  ...
  <a href="camp.php"   <?php if($active=='camp') echo "class='act'"; ?>><span class="glyphicon glyphicon-edit"></span>&nbsp&nbsp Camp</a>
  <a href="gallerymanage.php"   <?php if($active=='gallerymanage') echo "class='act'"; ?>><span class="glyphicon glyphicon-edit"></span>&nbsp&nbsp Gallery</a>
  <a href="galleryadd.php"   <?php if($active=='galleryadd') echo "class='act'"; ?>><span class="glyphicon glyphicon-edit"></span>&nbsp&nbspAdd Gallery</a>
